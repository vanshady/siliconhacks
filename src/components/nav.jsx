...
const Nav = React.createClass({
  render() {
    return (
      <nav id="nav">
        <img id="logo_white" className="logo" src="assets/img/logo_green.png" alt="Calhacks" />
        <img id="logo_orange" className="logo" src="assets/img/logo_green.png" alt="Calhacks" />
